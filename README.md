...
**【免責事項】**  
本プロジェクトは**完全な個人の趣味および技術実験を目的**として開発されているものです（そのため、既存の `find` と互換性のない尖った仕様が含まれています）。  
本ソフトウェアの使用によって生じたいかなる損害、データ損失、あるいはトラブル等についても、開発者は一切の責任を負いません。自己責任のもとでご利用ください。
